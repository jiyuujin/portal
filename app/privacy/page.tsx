  ...
  return (
    <div className="min-h-screen bg-background container py-12 max-w-3xl">
      ...
      <div className="space-y-4 text-muted-foreground leading-relaxed">
        <p>
          This website uses Google Analytics and Google AdSense to analyze
          traffic and show advertisements.
        </p>
        <h2 className="text-xl font-semibold text-foreground pt-4">
          1. Information Collection
        </h2>
        <p>
          We may collect cookies and usage data through third-party services
          such as Google Analytics to help us understand how the site is being
          used.
        </p>
        <h2 className="text-xl font-semibold text-foreground pt-4">
          2. Use of Cookies
